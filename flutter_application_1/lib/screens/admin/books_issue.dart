...
import '../models/bookissue_model.dart';
import 'admin_login.dart';

Future<List<Record>> fetchData() async {
  var url = Uri.parse("https://anuveni.000webhostapp.com/api7.php");
...
class xyz2 extends StatelessWidget {
  const xyz2({super.key});
  ...
  Widget build(BuildContext context) {
    return Stack(children: <Widget>[
      ...
      Scaffold(
          ...
          appBar: AppBar(
            title: const Text("Issue Requests"),
            backgroundColor: Colors.transparent,
          ),
          body: BookList())
    ]);
                      ...
                      child: Row(
                          ...
                          children: <Widget>[
                            ElevatedButton(
                                onPressed: () {
                                  String url =
                                      "https://anuveni.000webhostapp.com/accept_issue.php" +
                                          "?bookid=" +
                            ...
                            ElevatedButton(
                                onPressed: () {
                                  String url =
                                      "https://anuveni.000webhostapp.com/reject_issue.php" +
                                          "?bookid=" +
                                          snapshot.data![index].bookid +
                                          "&userid=" +
                                          snapshot.data![index].userid;
